...
<head>
    ...
    <title>Reza Behzadi's Profile</title>
    <style>
        body {
            background-color: #40E0D0; /* رنگ آبی فیروزه‌ای */
            color: #333; /* رنگ متن برای بهتر دیده شدن */
            font-family: Arial, sans-serif; /* فونت پیش‌فرض */
        }
    </style>
</head>
<body>
